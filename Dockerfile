...
ARG SENTRY_URL=${SENTRY_AUTH_TOKEN}
ARG VITE_BACKEND_URL=${VITE_BACKEND_URL}
ARG VITE_AMPLITUDE_API_KEY=${VITE_AMPLITUDE_API_KEY}
ARG VITE_VITE_ANALYTICS_KEY=${VITE_VITE_ANALYTICS_KEY}
ARG VITE_APP_BASE_LINK=${VITE_APP_BASE_LINK}
ARG VITE_SENTRY_DSN=${VITE_SENTRY_DSN}
ARG VITE_ADSGRAM_BLOCK_ID=${VITE_ADSGRAM_BLOCK_ID}
