...
export default function ({
  ...
  return (
    <div
      className="flex flex-row gap-x-1 items-center text-white/50 hover:text-white/80 active:text-white/50 font-accent font-semibold text-sm transition-colors cursor-pointer"
